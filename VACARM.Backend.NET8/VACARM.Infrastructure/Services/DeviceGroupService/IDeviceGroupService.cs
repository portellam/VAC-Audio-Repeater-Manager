...
namespace VACARM.Infrastructure.Services
{
  public partial interface IDeviceGroupService
  {
    ...
    DeviceModel GetByActualId(string actualId);
    DeviceModel GetDefaultCommunications();
    DeviceModel GetDefaultConsole();
    DeviceModel GetDefaultMultimedia();
    IEnumerable <DeviceModel> GetAllAbsent();
    IEnumerable <DeviceModel> GetAllAlphabetical();
    IEnumerable <DeviceModel> GetAllAlphabeticalDescending();
    ...
    IEnumerable <DeviceModel> GetAllUnmuted();
    ...
    /// <summary>
    /// Restart the enumerable of all <typeparamref name="DeviceModel"/>(s).
    /// </summary>
    void RestartAll();
    ...
    /// <summary>
    /// Restart an enumerable of some <typeparamref name="DeviceModel"/>(s).
    /// </summary>
    ...
    /// <summary>
    /// Start the enumerable of all <typeparamref name="DeviceModel"/>(s).
    /// </summary>
    void StartAll();
    ...
    /// <summary>
    /// Stop the enumerable of all <typeparamref name="DeviceModel"/>(s).
    /// </summary>
    void StopAll();
    ...
    /// <summary>
    /// Update the enumerable of all <typeparamref name="DeviceModel"/>(s).
    /// </summary>
    void UpdateAll();

    /// <summary>
    /// Update an enumerable of some <typeparamref name="DeviceModel"/>(s).
    /// </summary>
    /// <param name="idEnumerable">The enumerable of ID(s)</param>
